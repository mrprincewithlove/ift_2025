<div id="removable-div-{{$product_count}}" class="flex flex-row">
    <div id="product-div-{{$product_count}}" class="flex flex-row gap-2 w-full">
        <div class="w-full">
            <div>
                <label for="crud-form-1" class="form-label w-full flex flex-col sm:flex-row-label">{{__('translates.product')}}</label>
        ...
        <div class="flex flex-row gap-2 w-full items-end">
            <div>
                <label for=""  class="form-label w-full flex flex-col sm:flex-row-label">{{__('translates.product_price')}}</label>
            ...
            <div>
                <label for="" class="form-label w-full flex flex-col sm:flex-row-label">{{__('translates.product_quantity')}}</label>
            ...
            <div>
                <label for="" class="form-label w-full flex flex-col sm:flex-row-label">{{__('translates.product_discount')}}</label>

                <input id="product-disc-{{$product_count}}" type="number" min="0" step="0.01" class="product-disc form-control w-full" name="product-disc-{{$product_count}}"
                       value="0">
            </div>
            <div>
                <label for="" class="form-label w-full flex flex-col sm:flex-row-label">{{__('translates.total_price')}}</label>
