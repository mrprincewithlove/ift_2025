...
<div class="grid grid-cols-3 gap-2 w-full">
    <div>
        ...
        <input id="title_tm" type="text" class="form-control w-full" name="title_tm" required
               value="{{old('title_tm' , $sponsorPage->title_tm)}}">
    </div>
    <div>
        ...
        <input id="title_ru" type="text" class="form-control w-full" name="title_ru" required
               value="{{old('title_ru' , $sponsorPage->title_ru)}}">
    </div>
    <div>
        ...
        <input id="title_en" type="text" class="form-control w-full" name="title_en" required
               value="{{old('title_en' , $sponsorPage->title_en)}}">
    </div>
...
<div class="grid grid-cols-3 gap-2 w-full">
    <div>
        ...
        <input id="main_breadcrumb_title_tm" type="text" class="form-control w-full" name="main_breadcrumb_title_tm" required
               value="{{old('main_breadcrumb_title_tm' , $sponsorPage->main_breadcrumb_title_tm)}}">
    </div>
    <div>
        ...
        <input id="main_breadcrumb_title_ru" type="text" class="form-control w-full" name="main_breadcrumb_title_ru" required
               value="{{old('main_breadcrumb_title_ru' , $sponsorPage->main_breadcrumb_title_ru)}}">
    </div>
    <div>
        ...
        <input id="main_breadcrumb_title_en" type="text" class="form-control w-full" name="main_breadcrumb_title_en" required
               value="{{old('main_breadcrumb_title_en' , $sponsorPage->main_breadcrumb_title_en)}}">
    </div>
...
<div class="grid grid-cols-3 gap-2 w-full">
    <div>
        <label for="list_section_title_tm" class="form-label w-full flex flex-col sm:flex-row-label">{{__('translates.list_section_title_tm')}}
            <span class="h-4 sm:ml-auto mt-1 sm:mt-0 text-xs text-slate-500">{{__('translates.required')}}</span></label>

        <input id="list_section_title_tm" type="text" class="form-control w-full" name="list_section_title_tm" required
               value="{{old('list_section_title_tm' , $sponsorPage->list_section_title_tm)}}">
    </div>
    <div>
        <label for="list_section_title_ru" class="form-label w-full flex flex-col sm:flex-row-label">{{__('translates.list_section_title_ru')}}
            <span class="h-4 sm:ml-auto mt-1 sm:mt-0 text-xs text-slate-500">{{__('translates.required')}}</span></label>

        <input id="list_section_title_ru" type="text" class="form-control w-full" name="list_section_title_ru" required
               value="{{old('list_section_title_ru' , $sponsorPage->list_section_title_ru)}}">
    </div>
    <div>
        <label for="list_section_title_en" class="form-label w-full flex flex-col sm:flex-row-label">{{__('translates.list_section_title_en')}}
            <span class="h-4 sm:ml-auto mt-1 sm:mt-0 text-xs text-slate-500">{{__('translates.required')}}</span></label>

        <input id="list_section_title_en" type="text" class="form-control w-full" name="list_section_title_en" required
               value="{{old('list_section_title_en' , $sponsorPage->list_section_title_en)}}">
    </div>
    ...
    <div class="w-full items-center justify-center">
        <div class="w-full flex flex-col items-center justify-center  mt-3 overflow-hidden">
            <img id="image_img" class="inline-block w-18 h-12  text-gray-300 rounded-md border"
                 src="{{  asset($sponsorPage->main_background_image ?  $sponsorPage->main_background_image : 'images/imageplaceholder.jpg') }}"
                 alt="">
