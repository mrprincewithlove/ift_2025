...
@section('content')
	<h2 class="intro-y text-lg font-medium mt-10">
		{{__('translates.Meeting_items')}}
	</h2>

	<div class="grid grid-cols-12 gap-6 mt-5">
		<div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
			<a href="{{route('meeting-page-items.create')}}"
						...
						<tr class="intro-x">
							...
							<td class="table-report__action w-56">
								<div class="flex justify-center items-center">
									<a class="flex items-center mr-3" href="{{route('meeting-page-items.edit', $r)}}">
			...
			<div id="delete-confirmation-modal{{$r->id}}" class="modal" tabindex="-1" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<form  action="{{route('meeting-page-items.destroy', $r)}}" method="POST" class="modal-body p-0">
							@csrf
							@method('delete')
