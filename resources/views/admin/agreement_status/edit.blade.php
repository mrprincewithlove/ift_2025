...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-12">
            <!-- BEGIN: Form Layout -->
            <form action="{{route('agreement-statuses.update', $agreement_status)}}" enctype="multipart/form-data"  method="POST" class="intro-y box p-5">
                @csrf
                @method('put')

                @include('admin.agreement_status.form')
