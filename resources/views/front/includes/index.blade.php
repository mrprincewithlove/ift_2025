            ...
            <div class="container">
                <div class="w-full px-5 md:px-10 py-10 flex flex-col gap-5 md:gap-10">
                    ...
                    />
                        ...
                        <a href="{{ route('front.hotel') }}" class="group bg-white active:bg-primary md:hover:bg-primary w-full max-w-[440px] flex flex-col items-center justify-start gap-2 text-center text-balance rounded-xl px-4 py-8 customShadow active:scale-105 md:hover:scale-105 transition-all">
                            <div class="size-20 text-primary group-active:text-white md:group-hover:text-white">
                                <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="currentColor"
