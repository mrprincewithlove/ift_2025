                ...
                <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10">
                    <div class="flex flex-col items-center md:items-start justify-start gap-2 text-center md:text-start text-balance">
                        <h1 class="text-headerColor text-4xl md:text-5xl lg:text-6xl font-semibold">
                            Delegatlary hasaba almak üçin anketa:
                        </h1>
                    ...
                    <form action="{{ route('front.register.send') }}" method="POST" enctype="multipart/form-data"
                            id="registerForm"
                    ...
                    >
                        ...
                        <div class="col-span-2 sm:col-span-1 flex flex-col justify-end">
                            ...
                            <select name="country" id="country" class="js-example-basic-single w-full border-2 border-textColor p-3 text-base md:text-lg rounded-xl focus:border-primary outline-none">
                                @foreach($countries as $country)
                                    <option value="{{$country['id']}}">{{ $country['name_'.app()->currentLocale()] }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-span-2 sm:col-span-1 flex flex-col justify-end">
                        ...
                        <div class="col-span-2 sm:col-span-1 flex flex-col justify-end">
                            <label
                                    ...
                                    class="w-fit text-textColor text-base md:text-lg font-semibold"
                            >Telefon belgi (Whatsup, Telegram, Skype, WeChat)</label
                            >
                            <input
                                    type="text"
                        ...
                        <div class="col-span-2 sm:col-span-1 flex flex-col justify-end">
                            ...
                            >
                                ...
                                <option value="Speaker">Çykyş ediji</option>
                                <option value="Diplomat">Diplomat</option>
                                <option value="Sponsor">Hemaýatkär</option>
                            </select>
                        </div>
                        <div class="col-span-2 sm:col-span-1 flex flex-col justify-end">
                            <label
                            ...
                            <div class="flex items-center gap-2">
                                <div class="flex items-center input">
                                    ...
                                    <label
                                            for="radio1"
                                            class="flex items-center cursor-pointer text-textColor text-base md:text-lg"
                                    >
                        <span
                                class="w-6 h-6 inline-block mr-2 rounded-full border border-textColor flex-no-shrink"
                        ></span>
                                        Hawa</label
                                    >
                                </div>
                        ...
                        <button
                                id="submitButton"
                                class="col-span-2 p-3 rounded-xl bg-primary text-white text-lg font-semibold active:bg-secondary md:hover:bg-secondary transition-all"
                        >
                            Ugratmak
                        </button>
                    </form>
