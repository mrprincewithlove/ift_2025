        ...
        >
            <div class="container">
                ...
                >
                    ...
                    >
                        IFT 2025 «Türkmenistanyň geljegine maýa goýumlar»
                    </h1>
                    <h4 class="text-white text-xl md:text-2xl text-center max-w-5xl">
                        Hususy pudaga maýa goýumlaryny çekmek boýunça halkara forumy
                    </h4>
                    <p
                            class="text-white text-base md:text-lg font-semibold text-center max-w-5xl"
                    >
                        18.03.2025 Aşgabat, Türkmenistan
                    </p>
                    <a
            ...
            >
                <div class="flex flex-col gap-2">
                    ...
                    <p class="text-white text-base md:text-lg line-clamp-6">
                        2025-nji ýyl Türkmenistanda  «Halkara parahatçylyk we ynanyşmak
                        ýyly» diýlip yglan edildi, bu bolsa ýurduň halkara
                        hyzmatdaşlygyny pugtalandyrmaga, halklaryň arasynda parahatçylyk
                        we özara ynanyşmak ýörelgelerini ilerletmäge bolan maksadyny
                        tassyklaýar. Şunuň bilen baglylykda, şu ýylyň mart aýynda
                        Türkmenistanda ilkinji gezek «Türkmenistanyň geljegine maýa
                        goýumlar» atly IFT 2025 halkara forumy geçiriler.
                    </p>
                    <a
                            href=""
                    ...
                    >
                        ...
                        >
                            ...
                            <p class="text-white text-base md:text-lg">
                                Biz bilen bolan telekeçileriň sany
                            </p>
                        </div>
                        <div
                                class="w-full flex flex-col items-center justify-start gap-2 text-center text-balance"
...
150 0 0 -345z"
                        ...
                        >
                            ...
                            <p class="text-white text-base md:text-lg">
                                Ýyldan bäri işlemäge ýardam berýäris
                            </p>
                        </div>
                        <div
                                class="w-full flex flex-col items-center justify-start gap-2 text-center text-balance"
    ...
    <section class="w-full bg-primary">
        <div class="container">
            <div class="w-full px-5 md:px-10 py-10 flex flex-col gap-5 md:gap-10">
                <div class="flex flex-col items-center justify-center gap-2">
                    <h1
                            class="text-white text-4xl md:text-5xl lg:text-6xl font-semibold text-center"
                    >
                        NÄME ÜÇIN IFT 2025-e GATNAŞMALY
                    </h1>
                    <!-- <p class="text-white text-base md:text-lg">
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit. Totam,
                      earum?
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div class="flex flex-col gap-2">
                                <h4 class="text-white text-xl md:text-2xl font-semibold">
                                    Baý işewürlik we medeni maksatnamasy
                                </h4>
                                <p class="text-white text-base md:text-lg"></p>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        >
                            <div class="flex flex-col gap-2">
                                <h4 class="text-white text-xl md:text-2xl font-semibold">
                                    Işewürlik aragatnaşygy we networking üçin giňişlik
                                </h4>
                                <p class="text-white text-base md:text-lg"></p>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        >
                            <div class="flex flex-col gap-2">
                                <h4 class="text-white text-xl md:text-2xl font-semibold">
                                    Iň täze tehnologiýalar bilen tanyşdyrýan sergiler
                                </h4>
                                <p class="text-white text-base md:text-lg"></p>
                            </div>
                        </div>
            ...
            >
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <p class="text-white text-base md:text-lg line-clamp-6">
                        ...
                        döredilmeginiň 17 ýyllygy mynasybetli 2025-nji ýylyň 17 – 19-njy
                        martynda sergi guralar. TSTB-niň dürli pudaklarda ýöriteleşen
                        200-den gowrak agzasy önümleri we birleşmäniň 17 ýyllyk işiniň
                        dowamynda gazanan üstünlikleri bilen tanyşdyrarlar. Sergi
                        türkmen telekeçileriniň tejribesini we mümkinçiliklerini açyp
                        görkezer.Üç gün dowam etjek köpugurly sergi myhmanlary
                        Türkmenistanyň ykdysadyýetiniň hususy pudagynyň häzirki zaman
                        üstünlikleri bilen tanyşdyrar, bu ýerde kärhanalaryň innowasion
                        önümleriniň nusgalary, işewürligiň hödürleýän hyzmatlarynyň täze
                        görnüşleri görkeziler. Import edilýän harytlaryň ornuny tutýan
                        önümleriň – Türkmenistanda önümçiligi ýola goýlan we daşary ýurt
                        nusgalary bilen bäsdeşlige ukyply harytlaryň tanyşdyrylmagy uly
                        gyzyklanma döredýär.
                    </p>
                    <a
                            href=""
