...
@section('content')
    <main>
        <section class="relative">
            ...
            <div
                    class="absolute top-0 left-0 w-full h-screen bg-black bg-opacity-50 flex items-center justify-center"
            >
                <div class="container">
                    <div
                            class="w-full px-5 md:px-10 py-10 flex flex-col items-center justify-center gap-5 mt-10"
                    >
                        <h1
                                class="text-white text-4xl md:text-5xl lg:text-6xl text-center max-w-5xl font-bold"
                        >
                            IFT 2025 «Инвестиции в будущее Туркменистана»
                        </h1>
                        <h4 class="text-white text-xl md:text-2xl text-center max-w-5xl">
                            Международный форум по привлечению инвестиций в частный сектор
                        </h4>
                        <p
                                class="text-white text-base md:text-lg font-semibold text-center max-w-5xl"
                        >
                            18.03.2025 Ашхабад, Туркменистан
                        </p>
                        <a
                                href="{{ route('front.register') }}"
                                class="w-full max-w-lg text-center px-10 py-4 rounded-xl bg-primary text-white text-lg md:text-xl md:text-2xl font-semibold active:bg-secondary md:hover:bg-secondary transition-all"
                        >Hasaba alynmak</a
                        >
                    </div>
                </div>
        ...
        <section class="w-full bg-primary">
            <div class="max-w-[1680px] w-full ml-auto">
                <div
                        class="w-full pr-5 md:pr-0 pl-5 md:pl-10 py-10 grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10 items-center"
                >
                    <div class="flex flex-col gap-2">
                        ...
                        <p class="text-white text-base md:text-lg line-clamp-6">
                            В 2025 году в Туркменистане был объявлен «Международный год мира
                        ...
                        <a
                                href=""
                                class="text-white text-base md:text-lg font-semibold underline"
                        >
                            Читать далее</a
                        >
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-5">
                            <a
                                    href="/assets/files/konsepsiya.docx"
                                    target="_blank"
                                    class="text-center border-2 border-white px-10 py-2 rounded-xl bg-primary text-white text-base md:text-lg font-semibold active:bg-secondary md:hover:bg-secondary transition-all"
                            >
                            ...
                            >
                            <a
                                    href="/assets/files/broshura.pdf"
                                    target="_blank"
                                    class="text-center border-2 border-white px-10 py-2 rounded-xl bg-primary text-white text-base md:text-lg font-semibold active:bg-secondary md:hover:bg-secondary transition-all"
                            >Брошюра IFT 2025</a
                            >
                    ...
                    <div
                            class="border-[10px] border-r-[10px] md:border-r-0 border-primary customShadow rounded-xl md:rounded-none rounded-l-xl md:rounded-l-full overflow-hidden"
                    >
                        <img
                                src="/assets/images/image2.jpg"
                                alt=""
                                class="w-full rounded-xl md:rounded-none"
                        />
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="w-full px-5 md:px-10 py-10 flex flex-col gap-5 md:gap-10">
                    <div class="flex flex-col items-center justify-center gap-2">
                        <h1
                                class="text-headerColor text-4xl md:text-5xl lg:text-6xl font-semibold text-center text-balance max-w-5xl"
                        >
                            Наши услуги
                        </h1>
                    ...
                    <div
                            class="flex items-start justify-center flex-wrap gap-5 md:gap-10"
                    >
                        <a
                                href="./service-page.html"
                                class="group bg-white active:bg-primary md:hover:bg-primary w-full max-w-[440px] flex flex-col items-center justify-start gap-2 text-center text-balance rounded-xl px-4 py-8 customShadow active:scale-105 md:hover:scale-105 transition-all"
                        >
                            <div
                                    class="size-20 text-primary group-active:text-white md:group-hover:text-white"
                            >
                                <svg
                            ...
                            <h4
                                    class="text-headerColor group-active:text-white md:group-hover:text-white text-xl md:text-2xl font-bold transition-all"
                            >
                                Полет
                            </h4>
                            <span
                                    class="w-20 h-[2px] bg-headerColor group-active:bg-white md:group-hover:bg-white transition-all"
                            ></span>
                            <!-- <p class="text-textColor text-base md:text-lg line-clamp-4">
                              Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                              Vitae voluptatibus odit quod deserunt, sunt debitis aspernatur
                              repudiandae facere eveniet provident ipsa excepturi iste ab
                              molestias.
                            </p> -->
                        </a>
                        <a
                    ...
                    />
                        ...
                        >
                            ...
                            <span
                                    class="w-20 h-[2px] bg-headerColor group-active:text-white md:group-hover:text-white transition-all"
                            ></span>
                            <!-- <p class="text-textColor text-base md:text-lg line-clamp-4">
                              Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                              Vitae voluptatibus odit quod deserunt, sunt debitis aspernatur
        ...
        <section class="w-full min-h-screen relative">
            <div class="min-h-screen h-full w-full absolute top-0 left-0 -z-10">
                <img
                        src="/assets/images/tstb.jpg"
                        alt=""
                        class="w-full min-h-screen h-full object-cover"
                />
            </div>
            <div
                    class="w-full min-h-screen bg-black bg-opacity-50 flex items-center justify-center"
            >
                <div class="container">
                    <div
                            class="w-full px-5 md:px-10 py-10 flex flex-col gap-5 md:gap-10"
                    >
                        <h1
                                class="text-white text-4xl md:text-5xl lg:text-6xl text-center font-semibold"
                        >
                            Союз промышленников и предпринимателей Туркменистана
                        </h1>

                        <div
                                class="numberEl hiddenEl w-full flex flex-col md:flex-row items-start justify-evenly gap-5 md:gap-10"
                        >
                            <div
                                    class="w-full flex flex-col items-center justify-start gap-2 text-center text-balance"
                            >
                                ...
                                <h2
                                        akhi="29700"
                                        class="value text-white text-xl md:text-2xl font-bold"
                                >
                                    0
                                </h2>
                                <p class="text-white text-base md:text-lg">
                                    Количество предпринимателей с нами
                                </p>
                            </div>
                            <div
                                    class="w-full flex flex-col items-center justify-start gap-2 text-center text-balance"
...
39 -178 169 -407 625 -185 366 -201 391 -258 391 -10 0 -88 -39 -173 -87z"
                                ...
                                <p class="text-white text-base md:text-lg">
                                    Количество будущих предпринимателей, получивших образование
                                </p>
                            </div>
                        </div>
                        <div class="w-full flex items-center justify-center">
                            <a
                                    href=""
                                    class="px-10 py-2 rounded-xl bg-primary text-white text-base md:text-lg font-semibold active:bg-secondary md:hover:bg-secondary transition-all"
        ...
        {{--<section>--}}
            {{--<div class="container">--}}
                {{--<div class="w-full px-5 md:px-10 py-10 flex flex-col gap-5 md:gap-10">--}}
                    ...
                    {{--</div>--}}
                    {{--<div--}}
                            {{--class="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-10"--}}
                    {{-->--}}
                        {{--<a--}}
                                {{--href=""--}}
                                {{--class="w-full rounded-xl card p-4 flex flex-col gap-5 active:scale-105 md:hover:scale-105 transition-all"--}}
                        {{-->--}}
                            {{--<div class="w-full rounded-xl overflow-hidden">--}}
                                {{--<img src="/assets/images/invest1.jpg" alt="" class="w-full" />--}}
                            {{--</div>--}}
                            {{--<span--}}
                                    {{--class="w-fit text-white text-base md:text-lg px-10 py-2 rounded-xl bg-primary"--}}
                            {{-->--}}
                  {{--Gurluşyk we senagat--}}
                {{--</span>--}}
                            {{--<h4 class="text-headerColor text-xl md:text-2xl font-semibold">--}}
                                {{--Halkara derejeli ýokary tizlikli awtomobil ýoluny gurmak--}}
                            {{--</h4>--}}
                        {{--</a>--}}
                        {{--<a--}}
                                {{--href=""--}}
            ...
            {{--<div class="containesr">--}}
                {{--<div class="w-full py-10 flex flex-col">--}}
                    {{--<div class="flex flex-col items-center justify-center gap-2">--}}
                        ...
                        {{--</p> -->--}}
                    {{--</div>--}}
                    {{--<div class="w-full swiper speakerSlider py-10 px-5 md:px-0">--}}
                        {{--<div class="swiper-wrapper">--}}
                            {{--<div class="swiper-slide">--}}
                                {{--<a--}}
                                        {{--href=""--}}
                                        {{--class="w-full h-full rounded-xl bg-white customShadow flex flex-col items-center justify-start gap-5 p-4 active:scale-105 md:hover:scale-105 transition-all"--}}
                                {{-->--}}
                                    {{--<div class="">--}}
                                        {{--<img--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4--}}
                                            {{--class="text-headerColor text-xl md:text-2xl font-semibold"--}}
                                    {{-->--}}
                                        {{--Aman Amanow--}}
                                    {{--</h4>--}}
                                    {{--<span class="text-primary text-base md:text-lg">CEO</span>--}}
                                    {{--<p class="text-textColor text-base md:text-lg">Iş ýeri</p>--}}
                                {{--</a>--}}
                            {{--</div>--}}
                            {{--<div class="swiper-slide">--}}
                                {{--<a--}}
                        ...
                        {{--</div>--}}
                        {{--<!-- <div--}}
                        {{--class="custom-swiper-button-next absolute z-10 top-1/2 right-5 -translate-y-1/2 w-10 h-10 rounded-md hidden md:flex items-center justify-center bg-customWhite-50 text-primary-100 shadow-lg hover:text-white hover:bg-primary-100 transition-all"--}}
                      {{-->--}}
                        {{--<svg--}}
                          {{--xmlns="http://www.w3.org/2000/svg"--}}
                          {{--fill="none"--}}
                      ...
                      {{--</div>--}}
                      {{--<div--}}
                        {{--class="custom-swiper-button-prev absolute z-10 top-1/2 left-5 -translate-y-1/2 w-10 h-10 rounded-md hidden md:flex items-center justify-center bg-customWhite-50 text-primary-100 shadow-lg hover:text-white hover:bg-primary-100 transition-all"--}}
                      {{-->--}}
                        {{--<svg--}}
                          {{--xmlns="http://www.w3.org/2000/svg"--}}
                          {{--fill="none"--}}
                ...
                <div class="w-full px-5 md:px-10 py-10 flex flex-col gap-5 md:gap-10">
                    <div class="flex flex-col items-center justify-center gap-2">
                        <h1 class="text-white text-4xl md:text-5xl lg:text-6xl font-semibold text-center">
                            ЗАЧЕМ ПРИСОЕДИНЯТЬСЯ К IFT 2025?
                        </h1>
                        <!-- <p class="text-white text-base md:text-lg">
                          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Totam,
                          earum?
                    ...
                    <div
                            class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-10"
                    >
                        <a
                                href=""
                                class="group relative w-full min-h-[250px] bg-no-repeat bg-center gap-5 rounded-xl p-5 customShadow active:scale-105 md:hover:scale-105 transition-all"
                                style="background-image: url('/assets/images/image1.jpg')"
                        >
                            <div
                                    class="absolute top-0 left-0 w-full h-full flex flex-col justify-center text-center bg-black bg-opacity-50 rounded-xl p-2"
                            >
                                <div class="flex flex-col gap-2">
                                    <h4 class="text-white text-xl md:text-2xl font-semibold">
                                        Впечатляющий опыт
                            ...
                            <!-- <span
                              class="text-textColor text-base md:text-lg font-semibold flex items-center justify-center gap-2 px-10 py-2 rounded-xl bg-white group-hover:text-white group-hover:bg-primary transition-all"
                            >
                              Giňişleýin
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <a
                                href=""
                                class="group relative w-full min-h-[250px] bg-no-repeat bg-center gap-5 rounded-xl p-5 customShadow active:scale-105 md:hover:scale-105 transition-all"
                                style="background-image: url('/assets/images/image2.jpg')"
                        >
                            <div
                                    class="absolute top-0 left-0 w-full h-full flex flex-col justify-center text-center bg-black bg-opacity-50 rounded-xl p-2"
                            >
                                <div class="flex flex-col gap-2">
                                    <h4 class="text-white text-xl md:text-2xl font-semibold">
                                        Насыщенная деловая и культурная программа
                                    </h4>
                                    <p class="text-white text-base md:text-lg"></p>
                                </div>
                            </div>
                        ...
                        <a
                                href=""
                                class="group relative w-full min-h-[250px] bg-no-repeat bg-center gap-5 rounded-xl p-5 customShadow active:scale-105 md:hover:scale-105 transition-all"
                                style="background-image: url('/assets/images/image3.jpg')"
                        >
                            <div
                                    class="absolute top-0 left-0 w-full h-full flex flex-col justify-center text-center bg-black bg-opacity-50 rounded-xl p-2"
                            >
                                <div class="flex flex-col gap-2">
                                    <h4 class="text-white text-xl md:text-2xl font-semibold">
                                        Пространство для делового общения и нетворкинга
                                    </h4>
                                    <p class="text-white text-base md:text-lg"></p>
                                </div>
                            </div>
                        ...
                        >
                            ...
                            >
                                <div class="flex flex-col gap-2">
                                    <h4 class="text-white text-xl md:text-2xl font-semibold">
                                        Выставки, знакомящие с новейшими технологиями
                                    </h4>
                                    <p class="text-white text-base md:text-lg"></p>
                                </div>
                            </div>
        ...
        <section>
            <div class="container">
                <div
                        class="w-full px-5 md:px-10 py-10 grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10"
                >
        ...
        <section class="w-full bg-primary">
            <div class="max-w-[1680px] w-full mr-auto">
                <div
                        class="w-full pl-5 md:pl-0 pr-5 md:pr-10 py-10 grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10 items-center"
                >
                    <div
                            class="border-[10px] border-l-[10px] md:border-l-0 border-primary customShadow rounded-xl md:rounded-none rounded-r-xl md:rounded-r-full overflow-hidden"
                    >
                        <img
                                src="/assets/images/image2.jpg"
                                alt=""
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <p class="text-white text-base md:text-lg line-clamp-6">
                            В честь 17-летия образования Союза промышленников и
            ...
            <div class="container">
                <div class="w-full px-5 md:px-10 py-10 flex flex-col">
                    <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10">
                        <div
                                class="flex flex-col items-center md:items-start justify-start gap-2 text-center md:text-start text-balance"
                        >
                            <h1
                            ...
                            <div class="flex items-center flex-wrap gap-4 mt-5">
                                <a
                                        href=""
                                        class="text-textColor text-base md:text-lg flex items-center gap-2 font-semibold hover:text-primary transition-all"
                                >
                                    <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 24 24"
