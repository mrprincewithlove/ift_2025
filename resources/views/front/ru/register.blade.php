        ...
        <section class="relative">
            ...
            >
                <div class="container">
                    ...
                    >
                        <h1
                                class="text-white text-4xl md:text-5xl lg:text-6xl text-center max-w-5xl font-semibold"
                        >
                            Pегистрации
                        </h1>
                    ...
                    <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10">
                        <div class="flex flex-col items-center md:items-start justify-start gap-2 text-center md:text-start text-balance">
                            <h1 class="text-headerColor text-4xl md:text-5xl lg:text-6xl font-semibold">
                                Анкета для регистрации делегатов:
                            </h1>
                        ...
                        >
                            ...
                            <div class="col-span-2 sm:col-span-1 flex flex-col justify-end">
                                <label
                                        ...
                                        class="w-fit text-textColor text-base md:text-lg font-semibold"
                                >Номер телефона (Укажите Ваш контактный номер для экстренной
                                    связи в Whatsup, Telegram, Skype, WeChat):</label
                                >
                                <input
                                        type="text"
                            ...
                            <div class="col-span-2 sm:col-span-1 flex flex-col justify-end">
                                ...
                                >Нужна ли Вам виза для въезда на территорию
                                    Туркменистана</label
                                >
