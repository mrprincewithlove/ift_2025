...
<head><title></title><!--[if !mso]><!-->
    ...
    <style type="text/css">#outlook a, body {
            padding: 0
        }
    ...
    <style type="text/css">@import url(https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100..900;1,100..900&display=swap);</style>
    <!--<![endif]-->
    <style type="text/css">@media only screen and (max-width: 479px) {
        ...
        @media only screen and (max-width: 479px) {
            ...
            .mj-menu-checkbox[type=checkbox]:checked ~ .mj-menu-trigger .mj-menu-icon-close, .mj-menu-checkbox[type=checkbox] ~ .mj-inline-links > a {
                display: block !important
            }
...
<div lang="und" dir="auto">  <!--[if mso | IE]>
    <table align="center" border="0" cellpadding="0" cellspacing="0" class="" role="presentation" style="width:670px;"
           width="670">
        <tr>
    ...
    <div style="margin:0 auto;max-width:670px">
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%">
            <tbody>
            <tr>
                <td style="direction:ltr;font-size:0;padding:0 0 20px;text-align:center"> <!--[if mso | IE]>
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="" width="670px">
                                <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                                       style="width:670px;" width="670">
                                    <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                           role="presentation" style="margin:0;width:100%">
                                                        <tbody>
                                                        <tr>
                                                            <td align="left"
                                                                style="font-size:0;padding:50px 0 0 50px;word-break:break-word">
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                       role="presentation"
                                                                    ...
                                                                    <tr>
                                                                        <td style="width:190px"><img alt
                                                                                                     src="https://s.iimg.su/s/20/0f5t9PT56HyE2ic3r9aiHK0eMOn0tllSwYg00i5A.png"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div style="color:#fff;font-family:Montserrat,sans-serif;font-size:21px;font-weight:700;line-height:25px;text-align:left">
                                                                    Investment in the Future <br>of Turkmenistan
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left"
                                                                style="font-size:0;padding:19px 0 0 70px;word-break:break-word">
                                                                <div style="color:#fff;font-family:Montserrat,sans-serif;font-size:11px;font-weight:400;line-height:1;text-align:left">
                                                                    18 March 2025
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left"
                                                                style="font-size:0;padding:8px 0 0 70px;word-break:break-word">
                                                                <div style="color:#fff;font-family:Montserrat,sans-serif;font-size:11px;font-weight:400;line-height:1;text-align:left">
                                                        ...
                                                        <tr>
                                                            <td align="justify"
                                                                ...
                                                                <div style="color:#fff;font-family:Montserrat,sans-serif;font-size:14px;font-weight:600;line-height:22px;text-align:justify">
                                                                    <br><br>Thank you for registering for the IFT 2025:
                                                                    Investment in the Future of Turkmenistan. <br><br>To
                                                                    complete your registration process, we kindly remind
                                                                    you to sign the Delegate Agreement, which is
                                                                    necessary step to finalise your participation. Our
                                                                    team will be in touch with you soon.<br><br>Should
                                                                    you have any questions or need assistance, feel free
                                                                    to contact us at e-mail info@tmt.tm or +99312753648.
                                                                    <br><br>We look forward to welcoming you to the
                                                                    forum in March! <br><br>Best regards,
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="justify"
                                                                style="font-size:0;padding:10px 80px 0;word-break:break-word">
                                                                <div style="color:#fff;font-family:Montserrat,sans-serif;font-size:14px;font-weight:600;line-height:22px;text-align:justify">
                                                                    The Team of TMT Consulting Group <br><br>IFT 2025:
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                style="font-size:0;padding:50px 0 0;word-break:break-word">
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                       role="presentation"
                                                                       style="border-collapse:collapse;border-spacing:0">
                                                                    <tbody>
                                                                    <tr>
                                                                        <td style="width:190px"><img alt
                                                                                                     src="https://s.iimg.su/s/20/tjtuxDHA43nc31ljEEDcDjNSR4KWptqBG8xqt08L.png"
                                                                                                     style="border:0;display:block;font-size:13px;height:auto;outline:none;text-decoration:none;width:100%"
                                                                                                     width="190"
                                                                                                     height="auto"></td>
                                                                    </tr>
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                style="font-size:0;padding:10px 0 0;word-break:break-word">
                                                                <div style="color:#fff;font-family:Montserrat,sans-serif;font-size:25px;font-weight:600;line-height:22px;text-align:center">
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                style="font-size:0;padding-top:20px;word-break:break-word">
                                                                <div class="mj-inline-links"> <!--[if mso | IE]>
                                                                    <table role="presentation" border="0"
                                                                           cellpadding="0" cellspacing="0"
                                                                           align="center">
                                                                        <tr>
                                                                            <td style="padding:15px 10px;" class="">
                                                                    <![endif]--> <a class="mj-link"
                                                                                    href="tel:+99312753644"
                                                                                    target="_blank"
                                                                                    style="color:#fff;display:inline-block;font-family:Montserrat;font-size:16px;font-weight:400;line-height:20px;padding:15px 10px;text-decoration:none;text-transform:uppercase">
                                                                        +993 12 753644 </a> <!--[if mso | IE]></td>
                                                                    <td style="padding:15px 10px;" class=""><![endif]-->
                                                                    <a class="mj-link" href="tel:+99312753648"
                                                                       target="_blank"
