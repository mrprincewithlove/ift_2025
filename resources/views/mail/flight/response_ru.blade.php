                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div style="color:#fff;font-family:Montserrat,sans-serif;font-size:21px;font-weight:700;line-height:25px;text-align:left">
                                                                    Инвестиции в будущее <br>Туркменистана
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td align="justify"
                                                                ...
                                                                <div style="color:#fff;font-family:Montserrat,sans-serif;font-size:14px;font-weight:600;line-height:22px;text-align:justify">
                                                                    <br><br>Вы успешно указали информацию о рейсе.
                                                                    Напоминаем, что организаторы уже получили эти данные
                                                                    и будут учитывать их при подготовке к мероприятию.
                                                                    <br><br>Если информация изменится, пожалуйста,
                                                                    сообщите нам по электронной почте info@tmt.tm или по
                                                                    номеру +99312753648. <br><br>С наилучшими
                                                                    пожеланиями,
                                                                </div>
                                                            </td>
                                                        </tr>
