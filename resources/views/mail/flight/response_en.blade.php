                                                        ...
                                                        <tr>
                                                            <td align="justify"
                                                                ...
                                                                <div style="color:#fff;font-family:Montserrat,sans-serif;font-size:14px;font-weight:600;line-height:22px;text-align:justify">
                                                                    <br><br>You have successfully provided your flight
                                                                    details. Please note that the organizers have
                                                                    already received this information and will take it
                                                                    into account during the event preparations. <br><br>If
                                                                    there are any changes to the information, please let
                                                                    us know via email at info@tmt.tm or by number
                                                                    +99312753648.<br><br>Sincerely,
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
