                                                        ...
                                                        <tr>
                                                            <td align="justify"
                                                                ...
                                                                <div style="color:#fff;font-family:Montserrat,sans-serif;font-size:14px;font-weight:600;line-height:22px;text-align:justify">
                                                                    <br><br>Thank you for submitting a visa application
                                                                    for participation in the forum. Your request has
                                                                    been successfully received and will be processed
                                                                    within 24 hours. Our representative will contact you
                                                                    to provide all the necessary details. <br><br>If you
                                                                    have any additional questions, please feel free to
                                                                    contact us at +99365033447 or via email at
                                                                    a.atabaev@tmt.tm.<br><br>Sincerely,
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="justify"
                                                                style="font-size:0;padding:10px 80px 0;word-break:break-word">
                                                                <div style="color:#fff;font-family:Montserrat,sans-serif;font-size:14px;font-weight:600;line-height:22px;text-align:justify">
                                                                    The Turkmen Consulting Group Team <br><br>IFT 2025:
