...
class MeetingCompany extends Model
{
    ...
    {
        return (isset(static::$selectable) &&  count(static::$selectable) == 0) ? \Schema::getColumnListing((new MeetingCompany)->getTable()) : static::$selectable;
    }
