...
class ExibitionPage extends Model
{
    ...
    {
        return (isset(static::$selectable) &&  count(static::$selectable) == 0) ? \Schema::getColumnListing((new ExibitionPage)->getTable()) : static::$selectable;
    }
